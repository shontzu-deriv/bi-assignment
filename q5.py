...
def init_email():
    sender = "hello@gmail.com"  # add the sender gmail address here
    # add your e-mail recipients here
    recipients = ["alice@gmail.com", "bob@gmail.com"]
    subject = "hacker"  # add the subject of the e-mail you'd like here
